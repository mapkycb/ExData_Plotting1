...
# Making the plot
plot(times[I], A$Sub_metering_1, "l", xlab = "", ylab="Energy sub metering")
lines(times[I], A$Sub_metering_2, col = "red")
lines(times[I], A$Sub_metering_3, col = "blue")
legend("topright", names(A)[7:9], lty=1, col=c("black", "red", "blue"))
